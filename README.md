...
- The current script regenerates the **table view and its data**. The
  Gantt/Timeline view was hand-built during setup and stays static; ping
  whoever maintains this repo if you'd like that section made
  data-driven too — it's a natural next step but was out of scope for
  the first version.
